...
No exemplo, a partida for vencida na quarta tentativa, revelando a palavra-resposta "beira". Ao final da partida, é perguntado ao usuário se ele gostaria de jogar uma nova rodada. Caso queira, ele deve escrever 's' dentro do quadrado na resposta e confirmar com ENTER. Caso não, basta escrever qualquer outra letra, como 'n', e também confirmar com ENTER. Anter da confirmação, pode-se também apagar com a tecla '1'.
